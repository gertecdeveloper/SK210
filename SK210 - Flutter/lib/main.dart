...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _sensorbobina() async {
    try {
      await platform.invokeMethod('sensorbobina');
    } on PlatformException catch (e) {
      print(e.message);
    }
  }

  Future<void> _sensorpresence() async {
    try {
      await platform.invokeMethod('sensorpresence');
    } on PlatformException catch (e) {
      print(e.message);
    }
  }
  ...
  var listaNomeFuncoes = [
    ...
    {"name": "Sensor de Bobina", "img": "assets/bobina.png"},
    {"name": "Sensor de Presença", "img": "assets/sensor.png"},
  ...
  void trocarTela(int id) {
    switch (id) {
      ...
      case 2:
        _sensorbobina(); // Adicione os parênteses para chamar a função
        break;

      case 3:
        _sensorpresence(); // Adicione os parênteses para chamar a função
        break;
