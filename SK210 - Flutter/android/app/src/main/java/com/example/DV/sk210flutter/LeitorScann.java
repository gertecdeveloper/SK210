...
public class LeitorScann extends Activity implements View.OnClickListener {

    private Context mContext = LeitorScann.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leitor_scann);

        // Inicializando a camera
        mDecodeManager = com.example.DV.sk210flutter.DeviceServiceManager.getInstance().getCameraManager();
