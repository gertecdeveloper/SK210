package com.exampledv.msitefsk210;
...
import com.exampledv.msitefsk210.util.DeviceServiceManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Configura para não ajustar o conteúdo pelas janelas do sistema
        ...
        if (controller != null) {
            ...
            // Configura para permitir que as barras reapareçam com swipe
            ...
            if (requestCode == MSitef.REQ_CODE_MSITEF && data != null) {
                ...
                if (resultCode == RESULT_OK) {
                    if (retornoSitef.getCodResp().equals("0")) {
                        ...
                        template.clear();
                        template.add(new TextUnit(impressao, 20, Align.CENTER)); // Adiciona o texto ao template
